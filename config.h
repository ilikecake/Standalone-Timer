...
#define TWI_SCL_FREQ_HZ				100000

//Config for the UART module
#define UART_USER_CONFIG				//Define this in your user code to allow use of the UART module
#define UART_BAUD 9600					//UART baud rate
#undef UART_ENABLE_LOOPBACK				//Define this to enable a simple interrupt driven loopback on the UART
